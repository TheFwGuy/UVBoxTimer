...
#if defined(__LM4F120H5QR__) || defined(__TM4C1230C3PM__) || defined(__TM4C129XNCZAD__) || defined(__MSP430F5529__)
    //Screen_HX8353E myScreen(17, 31, 13, 39);
...
void Screen_HX8353E::begin()
{
    ...
    _writeRegister(HX8353E_COLMOD, 0x05);                                       // 16-bit colour
    delay(10);
    _writeRegister(HX8353E_MADCTL, HX8353E_MADCTL_RGB);                         // write mode
    
    _writeCommand(HX8353E_CASET);
    _writeData8888(0x00, 0x00, 0x00, 0x79);                                     // 128 x 128
...
void Screen_HX8353E::_setBacklight(bool flag)
{
    if (_pinScreenBacklight != NULL) digitalWrite(_pinScreenBacklight, flag);
}

void Screen_HX8353E::_setIntensity(uint8_t intensity)
{
    ;
}

void Screen_HX8353E::_orientCoordinates(uint16_t &x1, uint16_t &y1)
{
    ;
}

void Screen_HX8353E::_setOrientation(uint8_t orientation)
{
...
void Screen_HX8353E::_closeWindow()
{
...
void Screen_HX8353E::_writeCommand(uint8_t command8)
{
    ...
    //#else
    //    shiftOut(_pinSerialData, _pinSerialClock, MSBFIRST, command8);
    //#endif
...
void Screen_HX8353E::_writeData(uint8_t data8)
{
    ...
    SPI.transfer(data8);
    //#else
    //    shiftOut(_pinSerialData, _pinSerialClock, MSBFIRST, data8);
    //#endif
...
void Screen_HX8353E::_writeData16(uint16_t data16)
{
    ...
    //#else
    //    shiftOut(_pinSerialData, _pinSerialClock, MSBFIRST, highByte(data16));
    //    shiftOut(_pinSerialData, _pinSerialClock, MSBFIRST, lowByte(data16));
    //#endif
...
void Screen_HX8353E::_writeData88(uint8_t dataHigh8, uint8_t dataLow8)
{
    ...
    //#else
    //    shiftOut(_pinSerialData, _pinSerialClock, MSBFIRST, dataHigh8);
    //    shiftOut(_pinSerialData, _pinSerialClock, MSBFIRST, dataLow8);
    //#endif
